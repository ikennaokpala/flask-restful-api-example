...
pyenv-packages:
	...
	$(SUDO) rm -fr $(LSARP_API_PYTHON_BIN_PATH)/python && ln $(PYENV_ROOT)/versions/$(LSARP_API_PYTHON_INSTALL_VERSION)/bin/python$(LSARP_API_PYTHON_MAIN_VERSION) $(LSARP_API_PYTHON_BIN_PATH)/python
	$(SUDO) rm -fr $(LSARP_API_PYTHON_BIN_PATH)/pip && ln $(PYENV_ROOT)/versions/$(LSARP_API_PYTHON_INSTALL_VERSION)/bin/pip$(LSARP_API_PYTHON_MAIN_VERSION) $(LSARP_API_PYTHON_BIN_PATH)/pip
