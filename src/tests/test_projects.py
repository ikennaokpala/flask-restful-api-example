...
class TestCreateProject(TestProjectBase):
    ...
    def test_when_user_access_token_is_expired(self):
        with self.client as rdbclient:
            response = rdbclient.post(
                '/v1/projects', headers=self.headers, json=self.params
            )
    ...
    def test_when_user_access_token_is_valid_and_a_description_is_exempted(self):
        with self.client as rdbclient:
            response = rdbclient.post(
                ...
                json={'name': 'Metabolomics Project 1'},
            )
    ...
    def test_when_user_access_token_is_valid_and_a_name_are_exempted(self):
        with self.client as rdbclient:
            response = rdbclient.post(
                '/v1/projects', headers=self.headers, json={'description': ''}
            )
...
class TestProjects(TestProjectBase):
    ...
    def test_fetch_all_owned_and_collaborating_projects_without_page_and_per_page_and_direction(
        ...
        ProjectFactory.create(
            collaborators=['another@email.com'], owner='another@email.com'
        )
    ...
    def test_fetch_owned_and_collaborating_projects_with_page_1_and_per_page_with_direction_desc(
        ...
        with self.client as rdbclient:
            response = rdbclient.get(
                '/v1/projects?page=1&per_page=2&direction=desc', headers=self.headers
            )
    ...
    def test_fetch_owned_and_collaborating_projects_with_page_1_and_per_page_with_direction_asc(
        ...
        with self.client as rdbclient:
            response = rdbclient.get(
                '/v1/projects?page=1&per_page=2&direction=asc', headers=self.headers
            )
    ...
    def test_fetch_owned_and_collaborating_projects_with_page_2_nd_per_page_with_direction_desc(
        ...
        with self.client as rdbclient:
            response = rdbclient.get(
                '/v1/projects?page=2&per_page=2&direction=desc', headers=self.headers
            )
    ...
    def test_fetch_owned_and_collaborating_projects_with_page_2_and_per_page_with_direction_asc(
        ...
        with self.client as rdbclient:
            response = rdbclient.get(
                '/v1/projects?page=2&per_page=2&direction=asc', headers=self.headers
            )
...
class TestFetchAProject(TestProjectBase):
    ...
    def test_fetch_a_project(self):
        ...
        with self.client as rdbclient:
            response = rdbclient.get(
                '/v1/projects/' + project.slug, headers=self.headers
            )
...
class TestUpdateAProject(TestProjectBase):
    ...
    def test_update_a_project_when_not_found(self):
        ...
        with self.client as rdbclient:
            response = rdbclient.put(
                '/v1/projects/none-existing-project',
                headers=self.headers,
                json=self.params,
            )
