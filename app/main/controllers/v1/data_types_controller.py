...
data_type_field = endpoint.model('Resource', {'slug': fields.String,})
...
class DataTypes(Resource):
    ...
    @endpoint.doc(
        params={
            'page': 'Page or Offset for data_types',
            'per_page': 'Number of data_types per page',
...
@endpoint.doc(
    params={'name': 'Name of DataType', 'description': 'Description of the DataType'}
)
