...
from app.main.dao.data_type_metadata_shipment_dao import DataTypeMetadataShipmentDAO
...
@endpoint.param('data_type_id', 'The data_type identifier')
@endpoint.param('slug', 'The project slug identifier')
@endpoint.doc(params={'metadata_shipment_<index>': 'Metadata Shipment object', 'data_type_id': 'The data type identifier', 'slug': 'The project slug identifier'})
class DataTypeMetadataShipment(Resource):
	...
	def put(self, slug, data_type_id):
		try:
			return DataTypeMetadataShipmentDAO(data_type_id, request.files).upload(), 201
