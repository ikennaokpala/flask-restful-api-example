...
from app.main.dao.project_data_type_mzxml_file_dao import ProjectDataTypeMZXmlFileDAO
...
data_type_mzxmlfile_field = endpoint.model('Resource', {
    'id': fields.Integer,
    'name': fields.String,
...
class MZXmlFileProject(Resource):
    ...
    @endpoint.expect(model=data_type_mzxmlfile_field)
    def put(self, slug, data_type_slug):
        try:
            return ProjectDataTypeMZXmlFileDAO(data_type_slug, request.files).upload(), 201
