...
class MetadataShipment(db.Model):
	...
	raw_file_id = db.Column(db.Integer, db.ForeignKey('raw_files.id'), index=True, nullable=False)
	raw_file = db.relationship('RawFile', back_populates='metadata_shipments', lazy='joined')
