...
class SessionService:
	...
	def authorization_code_url(klazz):
		return OIDC.authorization_endpoint + '?' + urlencode(OIDC.authorization_code_params())
	...
	def valid(klazz, id_token):
		return verify(OpenIDClient(OIDC.issuer, OIDC.client_id, OIDC.client_secret), id_token)