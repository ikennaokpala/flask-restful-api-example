...
def upgrade():
    ...
    op.create_index(op.f('ix_mzxml_files_checksum'), 'mzxml_files', ['checksum'], unique=False)
    op.create_index(op.f('ix_mzxml_files_created_at'), 'mzxml_files', ['created_at'], unique=False)
    op.create_index(op.f('ix_mzxml_files_extension'), 'mzxml_files', ['extension'], unique=False)
    op.create_index(op.f('ix_mzxml_files_location'), 'mzxml_files', ['location'], unique=False)
    op.create_index(op.f('ix_mzxml_files_name'), 'mzxml_files', ['name'], unique=False)
    op.create_index(op.f('ix_mzxml_files_updated_at'), 'mzxml_files', ['updated_at'], unique=False)
