...
def upgrade():
    ...
    op.create_table('data_format_files',
    ...
    op.create_index(op.f('ix_data_format_files_created_at'), 'data_format_files', ['created_at'], unique=False)
    op.create_index(op.f('ix_data_format_files_data_type_id'), 'data_format_files', ['data_type_id'], unique=False)
    op.create_index(op.f('ix_data_format_files_extension'), 'data_format_files', ['extension'], unique=False)
    op.create_index(op.f('ix_data_format_files_name'), 'data_format_files', ['name'], unique=False)
    op.create_index(op.f('ix_data_format_files_updated_at'), 'data_format_files', ['updated_at'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_data_format_files_updated_at'), table_name='data_format_files')
    op.drop_index(op.f('ix_data_format_files_name'), table_name='data_format_files')
    op.drop_index(op.f('ix_data_format_files_extension'), table_name='data_format_files')
    op.drop_index(op.f('ix_data_format_files_data_type_id'), table_name='data_format_files')
    op.drop_index(op.f('ix_data_format_files_created_at'), table_name='data_format_files')
