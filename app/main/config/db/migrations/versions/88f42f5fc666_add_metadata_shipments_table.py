...
def upgrade():
    ...
    op.create_index(op.f('ix_metadata_shipments_mzxml_file_id'), 'metadata_shipments', ['mzxml_file_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_metadata_shipments_mzxml_file_id'), table_name='metadata_shipments')
